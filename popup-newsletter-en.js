(function () {
    ...
    var POPUP_ENABLED = false; // <- false to disable the popup
    ...
    var STRINGS = {
        badge:       'Free Resource',
        title:       'Get the digital marketing guide for SMEs',
        description: 'Practical strategies to generate more leads without increasing your budget. Delivered straight to your inbox.',
        namePlaceholder:  'Your name',
        emailPlaceholder: 'Your email',
        submit:      'Send me the guide →',
        legal:       'By submitting, you agree to our <a href="/politica-cookies.html" target="_blank" rel="noopener">privacy policy</a>.',
        successFn:   function (name, email) {
            return 'Thank you, ' + name + '! The guide has been sent to ' + email + '.';
        },
        errorGeneric:   'Something went wrong. Please try again.',
        errorName:      'Please enter your name.',
        errorEmail:     'Please enter a valid email address.',
        errorConsent:   'Please accept the terms to continue.',
        consentLabel:   'I agree to receive marketing communications from SICA Creative. I can unsubscribe at any time.'
    };
    ...
    function buildHTML() {
        ...
        '<button id="sica-popup-close" aria-label="Close" style="' + [
